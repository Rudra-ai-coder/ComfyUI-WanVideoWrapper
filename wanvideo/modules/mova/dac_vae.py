...
Modified for ComfyUI-WanVideoWrapper: removed audiotools dependency (BaseModel, AudioSignal,
compress/decompress), keeping only encode/decode/forward for inference.
"""
import math
